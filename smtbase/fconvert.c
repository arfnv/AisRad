...
*ec = FProcedure_NewCProcedure(gCP,gTP,&savSymbol,(LpCHAR)"money",(LpFUNC)&FConvert_ToMoney);
ExitOnError(*ec);
*ec = FProcedure_NewCProcedure(gCP,gTP,&savSymbol,(LpCHAR)"integer",(LpFUNC)&FConvert_ToInteger);
ExitOnError(*ec);
*ec = FProcedure_NewCProcedure(gCP,gTP,&savSymbol,(LpCHAR)"unsignedInteger",(LpFUNC)&FConvert_ToUnsignedInteger);
ExitOnError(*ec);
*ec = FProcedure_NewCProcedure(gCP,gTP,&savSymbol,(LpCHAR)"number",(LpFUNC)&FConvert_ToNumber);
ExitOnError(*ec);
...
*ec = FProcedure_NewCProcedure(gCP,gTP,&savSymbol,(LpCHAR)"character",(LpFUNC)&FConvert_ToCharacter);
ExitOnError(*ec);
*ec = FProcedure_NewCProcedure(gCP,gTP,&aSymbol,(LpCHAR)"boolean",(LpFUNC)&FConvert_ToBoolean);
ExitOnError(*ec);

*ec = FProcedure_NewCProcedure(gCP,gTP,&savSymbol,(LpCHAR)"string",(LpFUNC)&FConvert_ToString);
ExitOnError(*ec);
aSymbol     = TSymbol_MakeUnique(gCP,gTP,(LpCHAR)"numberToString");
TSymbol_SetGlobalValue(gCP,gTP,aSymbol,savSymbol->itsGlobalValue);

*ec = FProcedure_NewCProcedure(gCP,gTP,&savSymbol,(LpCHAR)"downcase",(LpFUNC)&FConvert_Downcase);
ExitOnError(*ec);
...
*ec = FProcedure_NewCProcedure(gCP,gTP,&savSymbol,(LpCHAR)"upcase",(LpFUNC)&FConvert_Upcase);
ExitOnError(*ec);
...
/*--------------------------------------------------------------------------------------- */
#if 0
FConvert_ToUnsignedInteger

The FConvert_ToUnsignedInteger function coerces the argument into an Unsigned Integer.

Note:   Exactly one argument is expected, anything else is an error.

#endif

TVAL FConvert_ToUnsignedInteger(LpXCONTEXT gCP,LpTHREAD gTP,NUM argc, TVAL argv[])
{
StartFrame
DeclareTVAL(ret);
DeclareTVAL(err);

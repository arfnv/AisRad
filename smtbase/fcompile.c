...
if ((_Tv(compilerState) != NIL) && (tmpEnv->itsMaxItemIndex > 32000))
	{
	*ret = TERROR("!compile: an Lambda cannot have more than 32000 temporary variables!");
    goto BadCleanUp;
	}
tmpEnv = _Sv(compilerState);
if ((tmpEnv != NIL) && (tmpEnv->itsMaxItemIndex == 0))
    _Sv(compilerState) = NIL;
if ((_Sv(compilerState) != NIL) && (tmpEnv->itsMaxItemIndex > 32000))
	{
	*ret = TERROR("!compile: an Lambda cannot have more than 32000 svars variables!");
    goto BadCleanUp;
	}
tmpEnv = _Pv(compilerState);
if ((tmpEnv != NIL) && (tmpEnv->itsMaxItemIndex == 0))
    _Pv(compilerState) = NIL;
if ((_Pv(compilerState) != NIL) && (tmpEnv->itsMaxItemIndex > 32000))
	{
...
if ((tmpEnv != NIL) && (tmpEnv->itsMaxItemIndex == 0))
    _Cv(compilerState) = NIL;
if ((_Cv(compilerState) != NIL) && (tmpEnv->itsMaxItemIndex > 32000))
	{

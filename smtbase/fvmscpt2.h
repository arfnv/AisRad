...
extern  void FVmScript2_DebugManager	(LpXCONTEXT gCP,LpTHREAD gTP,TLambda* self,NUM argc,TVAL argv[],TPcodeVector* Pc,TStructure* Pv,TStructure* Sv,LpTVAL Rb,LpREAL Vs,NUM VsTopOfStack,LpTVAL Fb,LpNUM Ip,TVAL errorMsg);

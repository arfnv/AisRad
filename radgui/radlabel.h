...
//	----------------------------------------------------- DEFINITIONS ---------------------------------------------------------
#define	RADMAXTEXTLABELSIZE	5000		
...
Implements the RadIde QLable pane. RadLabel panes come standard with support 
for rich text.
...
Implements the RadIde QLabel wrapper class.
...
********************************************************************************************/
class WrpLabel : public RadObject
{
// 	Q_OBJECT
...
//	WrpTextEdit constructor
	WrpLabel(RadLabel* parent,QWidget* display,const QString& className)
...
//	WrpLabel destructor
	WrpLabel::~WrpLabel()
	{
		RadLabel* aRadLabel = (RadLabel*)cpWrpRadParent;
		if (aRadLabel!=NULL) delete aRadLabel;
		cpWrpRadParent = NULL;
		cpWrpQWidget = NULL;
	}
...
//	Main Lisp Method
	virtual TVAL lisp(LpXCONTEXT gCP,LpTHREAD gTP,NUM argc,TVAL argv[])
	{
		return(((RadLabel*)cpWrpRadParent)->lisp(gCP,gTP,argc,argv));
	}
